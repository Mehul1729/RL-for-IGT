...
#     alpha, decay, lam, arb_lr = params # lr for limbic system, decay rate of memory (somatic marker), loss aversion (PVL), temperature for pfc, temperature for limbic, learning rate for arbitration
...
#         w_logits = rel_scores * 5.0 # to make it more sensitive to minor differences in reliabilities
#         w_logits -= np.max(w_logits) # scaling
...
def calculate_nll(params, choices, rewards, n_actions=4):
    """
    params: [alpha, decay, lambda_loss, beta_pfc]
    """
