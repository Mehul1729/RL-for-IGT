...
""" 
This is the code for setting up the final env that is suitable for both policy gradient and Q-learning agents.
...
# fucntion to calculate reward given the action 
    def _calculate_reward(self, action):
        ...
        reward =  np.random.choice(deck['reward'])  # stochastic reward
