...
if __name__ == '__main__':
    ...
    if choice == '2':
        ...
        # Check if the loaded env has 8 actions (extreme) or 6
        temp_env = GameEnv()
    ...
    # # Note: A *negative* loss here is good (it means a positive reward),
    # # and a *positive* loss is bad (it means a negative reward).
    # # The spikiness is normal.
